    ...
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="form-control mb-4">
          ...
          />
          {errors.banner && (
            <span className="text-red-500 text-sm">{errors.banner[0]}</span>
          )}
        </div>
        ...
        <div className="form-control mb-4">
          ...
          />
          {errors.start_date && (
            <span className="text-red-500 text-sm">{errors.start_date[0]}</span>
          )}
        </div>
        ...
        <div className="form-control mb-4">
          ...
          />
          {errors.price && (
            <span className="text-red-500 text-sm">{errors.price[0]}</span>
          )}
        </div>
        ...
        <div className="form-control mb-4">
          ...
          />
          {errors.seats && (
            <span className="text-red-500 text-sm">{errors.seats[0]}</span>
          )}
        </div>
